                                    ...
                                    <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
                                        <div className="min-w-0">
                                            <div className="flex flex-wrap items-center gap-2">
                                                ...
                                                <span
                                                    className={`rounded-full px-2.5 py-1 text-xs font-medium ${normalizePlan(item.member?.plan) === "pro"
                                                ...
                                                <span
                                                    className={`rounded-full px-2.5 py-1 text-xs font-medium ${getEnrollmentStatus(item) === "completed"
