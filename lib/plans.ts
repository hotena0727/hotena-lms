  ...
  switch (normalized) {
    ...
    case "basic":
      return {
        ...
        soft: "border-indigo-200 bg-indigo-50/70 text-indigo-900",
        tint: "border-indigo-200 bg-indigo-50",
        nav: "border-b border-indigo-100 bg-indigo-50/60",
        navActive: "border-b-2 border-indigo-500 text-indigo-900",
        navInactive: "text-indigo-700/80",
    ...
    case "plus":
      return {
        ...
        soft: "border-fuchsia-200 bg-fuchsia-50/70 text-fuchsia-900",
        tint: "border-fuchsia-200 bg-fuchsia-50",
        nav: "border-b border-fuchsia-100 bg-fuchsia-50/60",
        navActive: "border-b-2 border-fuchsia-500 text-fuchsia-900",
        navInactive: "text-fuchsia-700/80",
